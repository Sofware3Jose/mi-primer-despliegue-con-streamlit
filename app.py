...
st.title('LAS MEJORES Predicciónes de inversión en una tienda de videojuegos')
...
"""PREDICCIONES AAAAAAAAAAAAAAAAAAAAAA TUCU TUCU TUCU"""
...
st.warning("El modelo tiene un error del 9% (mape: error porcentual 17%)")
